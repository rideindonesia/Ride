...
router.post("/admin", async (_req, res) => {
  ...
  const settings = [
    ...
    { key: "call_fee_gocar_base", value: "5000", label: "Ride Mobil — Biaya Awal (Rp)" },
    ...
    { key: "motor_zone1_base", value: "9000", label: "Zona I — Tarif Minimum s/d 4 km (Rp)" },
    { key: "motor_zone1_per_km", value: "1500", label: "Zona I — Per Km berikutnya (Rp)" },
    { key: "motor_zone2_base", value: "10000", label: "Zona II (Jabodetabek) — Tarif Minimum s/d 4 km (Rp)" },
    { key: "motor_zone2_per_km", value: "2000", label: "Zona II (Jabodetabek) — Per Km berikutnya (Rp)" },
    { key: "motor_zone3_base", value: "9000", label: "Zona III — Tarif Minimum s/d 4 km (Rp)" },
