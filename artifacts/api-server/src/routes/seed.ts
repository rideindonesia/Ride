...
router.post("/admin", async (_req, res) => {
  ...
  const settings = [
    ...
    { key: "call_fee_gocar_base", value: "3000", label: "Ride Mobil — Biaya Awal (Rp)" },
    { key: "call_fee_gocar_per_km", value: "3600", label: "Ride Mobil — Per Km (Rp)" },
    // Kurir motor (goride/gosend/goshop/gofood) — tarif per zona (batas bawah Kemenhub).
    { key: "motor_zone1_base", value: "9250", label: "Zona I — Tarif Minimum s/d 4 km (Rp)" },
    { key: "motor_zone1_per_km", value: "1850", label: "Zona I — Per Km berikutnya (Rp)" },
    { key: "motor_zone2_base", value: "13000", label: "Zona II (Jabodetabek) — Tarif Minimum s/d 4 km (Rp)" },
    { key: "motor_zone2_per_km", value: "2600", label: "Zona II (Jabodetabek) — Per Km berikutnya (Rp)" },
    { key: "motor_zone3_base", value: "10500", label: "Zona III — Tarif Minimum s/d 4 km (Rp)" },
    { key: "motor_zone3_per_km", value: "2100", label: "Zona III — Per Km berikutnya (Rp)" },
