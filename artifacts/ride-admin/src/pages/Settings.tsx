...
const KEY_LABELS: Record<string, string> = {
  ...
  call_fee_gocar_base: "Ride Mobil — Biaya Awal (Rp)",
  call_fee_gocar_per_km: "Ride Mobil — Per KM (Rp)",
  motor_zone1_base: "Zona I — Tarif Minimum s/d 4 km (Rp)",
  motor_zone1_per_km: "Zona I — Per KM berikutnya (Rp)",
  motor_zone2_base: "Zona II (Jabodetabek) — Tarif Minimum s/d 4 km (Rp)",
  motor_zone2_per_km: "Zona II (Jabodetabek) — Per KM berikutnya (Rp)",
  motor_zone3_base: "Zona III — Tarif Minimum s/d 4 km (Rp)",
  motor_zone3_per_km: "Zona III — Per KM berikutnya (Rp)",
  motor_free_km: "Kurir Motor — KM tercakup tarif minimum",
  kirim_zone1_base: "RIDE Kirim — Zona I — Tarif Minimum s/d 4 km (Rp)",
  kirim_zone1_per_km: "RIDE Kirim — Zona I — Per KM berikutnya (Rp)",
  kirim_zone2_base: "RIDE Kirim — Zona II (Jabodetabek) — Tarif Minimum s/d 4 km (Rp)",
  kirim_zone2_per_km: "RIDE Kirim — Zona II (Jabodetabek) — Per KM berikutnya (Rp)",
  ...
  platform_fee_pct_trip: "Platform Fee Layanan Trip (%)",
  belanja_max_talangan: "Belanja — Batas Maksimal Talangan (Rp)",
};
...
const SETTING_GROUPS = [
  ...
  },
  {
    ...
    keys: [
      ...
      "motor_zone3_base", "motor_zone3_per_km",
      "motor_free_km",
    ],
  },
  {
    label: "RIDE Kirim per Zona (tarif terpisah dari Ride Motor)",
    keys: [
      "kirim_zone1_base", "kirim_zone1_per_km",
  ...
  {
    label: "Ride Mobil (Tarif Flat Nasional)",
    keys: ["call_fee_gocar_base", "call_fee_gocar_per_km"],
  },
  {
    label: "Biaya & Fee Platform",
    keys: [
      "call_fee_free_km", "biaya_layanan_admin",
      "platform_fee_pct", "platform_fee_pct_trip",
      "belanja_max_talangan",
    ],
  },
];
