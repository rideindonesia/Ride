...
const KEY_LABELS: Record<string, string> = {
  ...
  call_fee_goride_base: "Ride Ojek — Tarif Dasar (Rp)",
  call_fee_goride_per_km: "Ride Ojek — Per KM (Rp)",
  call_fee_gocar_base: "Ride Mobil — Tarif Dasar (Rp)",
  call_fee_gocar_per_km: "Ride Mobil — Per KM (Rp)",
  call_fee_gosend_base: "Ride Kirim — Tarif Dasar (Rp)",
  call_fee_gosend_per_km: "Ride Kirim — Per KM (Rp)",
  call_fee_goshop_base: "Ride Belanja — Tarif Dasar (Rp)",
  call_fee_goshop_per_km: "Ride Belanja — Per KM (Rp)",
  call_fee_gofood_base: "Ride Makan — Tarif Dasar (Rp)",
  call_fee_gofood_per_km: "Ride Makan — Per KM (Rp)",
...
const SETTING_GROUPS = [
  ...
  {
    label: "Biaya Panggilan Layanan Vertikal (Antar/Kirim)",
    keys: [
      "call_fee_goride_base", "call_fee_goride_per_km",
      "call_fee_gocar_base", "call_fee_gocar_per_km",
      "call_fee_gosend_base", "call_fee_gosend_per_km",
      "call_fee_goshop_base", "call_fee_goshop_per_km",
      "call_fee_gofood_base", "call_fee_gofood_per_km",
    ],
  },
  {
