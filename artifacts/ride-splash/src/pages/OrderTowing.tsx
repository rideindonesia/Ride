  ...
  useEffect(() => {
    ...
    const applyOd = (od: any) => {
      if (od.status === "accepted" && od.mitra) {
        ...
        setAcceptedMitra({ id: od.mitra.id, name: od.mitra.name, lat: mitraLat, lng: mitraLng, serviceType: od.mitra.serviceType, rating: od.mitra.rating ?? null, totalOrders: od.mitra.totalOrders ?? 0, dist, callFee: od.totalAmount ?? calcBiayaPanggilan("towing", dist), etaMin: calcEtaMinutes(dist) });
