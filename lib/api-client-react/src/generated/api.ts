 ...
 */
export const registerPengguna = async (registerPenggunaInput: RegisterPenggunaInput, options?: RequestInit): Promise<SendOtpResponse> => {
  ...
  return customFetch<SendOtpResponse>(getRegisterPenggunaUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(registerPenggunaInput)
  }
);}
...
export const getRegisterPenggunaMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof registerPengguna>>, TError,{data: BodyType<RegisterPenggunaInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof registerPengguna>>, TError,{data: BodyType<RegisterPenggunaInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof registerPengguna>>, {data: BodyType<RegisterPenggunaInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RegisterPenggunaMutationResult = NonNullable<Awaited<ReturnType<typeof registerPengguna>>>
    export type RegisterPenggunaMutationBody = BodyType<RegisterPenggunaInput>
    export type RegisterPenggunaMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Step 1 - Submit registration form and send OTP
 */
export const useRegisterPengguna = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof registerPengguna>>, TError,{data: BodyType<RegisterPenggunaInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof registerPengguna>>,
        TError,
        {data: BodyType<RegisterPenggunaInput>},
        TContext
      > => {
 ...
 */
export const verifyOtpPengguna = async (verifyOtpBody: VerifyOtpBody, options?: RequestInit): Promise<AuthResponse> => {
...
export const getVerifyOtpPenggunaMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyOtpPengguna>>, TError,{data: BodyType<VerifyOtpBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof verifyOtpPengguna>>, TError,{data: BodyType<VerifyOtpBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyOtpPengguna>>, {data: BodyType<VerifyOtpBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyOtpPenggunaMutationResult = NonNullable<Awaited<ReturnType<typeof verifyOtpPengguna>>>
 ...
 * @summary Step 2 - Verify OTP and create account
 */
export const useVerifyOtpPengguna = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyOtpPengguna>>, TError,{data: BodyType<VerifyOtpBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 * @summary Resend OTP
 */
export const resendOtpPengguna = async (resendOtpBody: ResendOtpBody, options?: RequestInit): Promise<SendOtpResponse> => {
...
export const getResendOtpPenggunaMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resendOtpPengguna>>, TError,{data: BodyType<ResendOtpBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof resendOtpPengguna>>, TError,{data: BodyType<ResendOtpBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resendOtpPengguna>>, {data: BodyType<ResendOtpBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResendOtpPenggunaMutationResult = NonNullable<Awaited<ReturnType<typeof resendOtpPengguna>>>
 ...
 * @summary Resend OTP
 */
export const useResendOtpPengguna = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resendOtpPengguna>>, TError,{data: BodyType<ResendOtpBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
