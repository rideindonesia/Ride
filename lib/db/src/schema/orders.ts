...
export const ordersTable = pgTable("orders", {
  ...
  tripDistanceKm: doublePrecision("trip_distance_km"),
  ...
  orderItems: json("order_items").$type<{ name: string; qty: number; price: number; note?: string }[]>(),
  foodTotal: integer("food_total"),
  merchantStatus: varchar("merchant_status", { length: 20 }),
  merchantReadyAt: timestamp("merchant_ready_at"),
